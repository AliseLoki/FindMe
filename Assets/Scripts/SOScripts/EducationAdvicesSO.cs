...
public class EducationAdvicesSO : ScriptableObject
{
    public List<string> _advices = new List<string>()
    {
      ...
      "подожди немного, если заказ приготовлен хорошо - не сырой и не сожженый, ты получишь деньги",
      "на деньги можно покупать что-то что я еще не придумала//////",
    ...
    // public string ChangeViewAdvice = "ты можешь менять вид камеры, нажми на красную лупу справа и регулируй приближение";
    //public string ChangeMusicVolumeAdvice = "таким же образом можно поменять громкость музыки, нажми на ноты";
    //public string ChangeSoundEffectsVolumeAdvice = "а также громкость музыкальных эффектов, нажми на значок динамика";
    //public string OpenTipsBookAdvice = " нажми на книгу в правом верхнем углу, она показывает подсказки ";
    //public string ExitGameAdvice = "нажав на карту в нижнем правом углу, ты выйдешь из игры";
    //public string TakeFirstOrder = "Подойди к домику птички, нажми на него, чтобы получить заказ";
