...
[CreateAssetMenu()]
public class AllTextsSO : ScriptableObject
{
    ...
    public string RunText = "беги вперед к дому бабушки, используй кнопки ЦФЫВ для передвижения, колесико мышки для приближения камеры";
    ...
    //VillagesName
    //public Dictionary<NamesOfVillages, string> NamesOfVillages = new()
    //{
    //    { Indexies.NamesOfVillages.Woodcutter,"дровосек" },
    //    { Indexies.NamesOfVillages.FirstVillageName,"грушевка" },
    //    { Indexies.NamesOfVillages.SecondVillageName,"яблоневка" },
    //    { Indexies.NamesOfVillages.ThirdVillageName,"коровино" },
    //    { Indexies.NamesOfVillages.FourthVillageName,"зеленовка" },
    //    { Indexies.NamesOfVillages.LastVillageName,"заречье" }
    //};
    ...
    //};
    // SignsSO
    //public Dictionary<SignsNumbers, List<string>> AllSignsText = new() 
    //{
