...
namespace SO
{
    ...
    public class AudioEffectsSO : ScriptableObject
    {
        ...
        public AudioClip PayingForWater;
        public AudioClip PresentFromAddOpen;
        public AudioClip RecievingOrders;
        public AudioClip TakingGold;
        public AudioClip ThrowingFood;
